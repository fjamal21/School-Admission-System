...
<%@ page
    import="com.admission.school.system.application.util.JdbcConnectioClass"%>
...
<body>
    ...
    <hr color="#FFD699">
    <center>
        <form:form id="studentSearchForm" name="studentSearchForm"
            action="search" method="POST" commandName="studentSearchForm">
            <br>
            <table cellspacing="5" cellpadding="5" bgcolor="#F0FFC2">
                ...
                <tr>
                    <td><b>Course</b></td>
                    <td><form:select path="course" style="width: 300px;">
            ...
            <tr>
                ...
                <c:forEach var="student" items="${studentList}">
                    <tr>
                        ...
                        <td><c:set scope="session" var="courseId"
                                value="${student.course}" /> <%
     int cId = (Integer) session.getAttribute("courseId");
 %> <a style="text-decoration: none; color: black;"
                            href="../view-cources?id=${student.course}"><%=jdbc.getCourseTitle(cId)%></a>
                        </td>
